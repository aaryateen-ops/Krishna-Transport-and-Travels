...
function HomeContent() {
  ...
  const t = {
    hi: {
      ...
      step1Title: "1. बुकिंग फॉर्म भरें",
      step1Desc: "कहाँ से कहाँ जाना है और तारीख चुनकर नीचे फॉर्म भरें।",
      step2Title: "2. व्हाट्सएप पर किराया तय करें",
      step2Desc: "रोहित भैया से सीधे व्हाट्सएप या कॉल पर बात करके किराया तय करें और बुकिंग कन्फर्म करें।",
      step3Title: "3. अपनी गाड़ी लाइव ट्रैक करें",
      step3Desc: "बुकिंग कोड को ऊपर 'गाड़ी ट्रैक करें' में डालकर अपनी गाड़ी और ड्राइवर का लाइव स्टेटस देखें।",
    ...
    en: {
      ...
      step1Title: "1. Submit Booking Form",
      step1Desc: "Fill out the form below with your details, route, and booking date.",
      step2Title: "2. Set Price on WhatsApp",
      step2Desc: "Negotiate and finalize pricing directly with Rohit via WhatsApp chat or call.",
      step3Title: "3. Track Your Vehicle Live",
      step3Desc: "Use your Booking Code in the 'Track Booking' page to check your assigned vehicle, driver, and trip status live.",
