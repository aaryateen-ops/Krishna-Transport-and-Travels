...
function HomeContent() {
  ...
  const t = {
    hi: {
      ...
      inquiryTag: "बुकिंग और ट्रैकिंग (Booking & Tracking)",
      inquiryTitle: "3 आसान स्टेप्स में बुक और ट्रैक करें",
      inquiryDesc: "गाड़ी बुक करने और उसका लाइव स्टेटस ट्रैक करने का आसान तरीका:",
      step1Title: "1. ऑनलाइन बुकिंग फॉर्म भरें",
      step1Desc: "नीचे दिए गए फॉर्म में अपना नाम, कहाँ से कहाँ सामान भेजना है और तारीख भरें।",
      step2Title: "2. किराया फाइनल करें",
      step2Desc: "रोहित भैया से सीधे व्हाट्सएप या कॉल पर बात करके किराया तय करें। बुकिंग कन्फर्म होते ही आपको एक 'बुकिंग कोड' मिलेगा।",
      step3Title: "3. कोड से लाइव ट्रैक करें",
      step3Desc: "ऊपर 'गाड़ी ट्रैक करें' (Track Booking) में अपना बुकिंग कोड डालकर गाड़ी, ड्राइवर और डिलीवरी का लाइव स्टेटस देखें।",
      ...
      testi1Text: "मैंने सिगरा से सलारपुर घर शिफ्ट करने के लिए कृष्णा ट्रांसपोर्ट से संपर्क किया। रोहित जी ने बहुत मदद की। उन्होंने वाजिब दाम में टाटा मैजिक गाड़ी और दो हेल्पर दिए। बहुत बढ़िया सर्विस!",
      ...
      addrValue: "सलारपुर, विद्या विहार इंटर कॉलेज के पीछे, वाराणसी, उत्तर प्रदेश - 221007",
    ...
    en: {
      ...
      inquiryTag: "Booking & Tracking",
      inquiryTitle: "Book & Track in 3 Easy Steps",
      inquiryDesc: "The simple way to book a ride and track your order live:",
      step1Title: "1. Fill Online Booking Form",
      step1Desc: "Enter your name, pickup/drop details, and booking date in the form below.",
      step2Title: "2. Confirm Rate & Get Booking Code",
      step2Desc: "Talk to Rohit directly on WhatsApp/Call to finalize pricing. Once confirmed, you will receive a unique Booking Code.",
      step3Title: "3. Track Live using Booking Code",
      step3Desc: "Enter your Booking Code in the 'Track Booking' page to track your assigned vehicle, driver, and shipment status live.",
